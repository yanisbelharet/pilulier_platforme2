  ...
  return (
    <div className="min-h-screen bg-slate-100 pb-24 font-sans text-slate-800" dir="rtl">
      <div className="max-w-2xl mx-auto bg-white shadow-2xl min-h-screen overflow-hidden flex flex-col">
        {/* 1. Image 1 */}
        <img src={img1} alt="Product" loading="eager" decoding="async" fetchpriority="high" width="600" height="800" className="w-full h-auto" />
        ...
        {/* 4. Images List */}
        <img src={img2} alt="Product details" loading="lazy" decoding="async" width="600" height="800" className="w-full h-auto" />
        <img src={img3} alt="Product details" loading="lazy" decoding="async" width="600" height="800" className="w-full h-auto mt-2" />
        <img src={img4} alt="Product details" loading="lazy" decoding="async" width="600" height="800" className="w-full h-auto mt-2" />
        <img src={img5} alt="Product details" loading="lazy" decoding="async" width="600" height="800" className="w-full h-auto mt-2" />
